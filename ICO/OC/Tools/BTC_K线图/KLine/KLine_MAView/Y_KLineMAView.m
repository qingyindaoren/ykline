...
-(void)maProfileWithModel:(Y_KLineModel *)model
{
    ...
    if (model.High.floatValue<10||_isFull) {
        _openLabel.text = [NSString stringWithFormat:@"%.8f",model.Open.floatValue];
        
        _highLabel.text = [NSString stringWithFormat:@"%.8f",model.High.floatValue];
        
        _lowLabel.text = [NSString stringWithFormat:@"%.8f",model.Low.floatValue];
        
        _closeLabel.text = [NSString stringWithFormat:@"%.8f",model.Close.floatValue];
        
        
        _MA7Label.text = [NSString stringWithFormat:@" MA7: %.8f ",model.MA7.floatValue];
        _MA30Label.text = [NSString stringWithFormat:@" MA30: %.8f",model.MA30.floatValue];
    }else{
...
-(void)setIsFull:(BOOL)isFull{
    ...
    _openLabel.font = [UIFont boldSystemFontOfSize:10*scale];
    _closeLabel = [self private_createLabel];
     _closeLabel.font = [UIFont boldSystemFontOfSize:10*scale];
    _highLabel = [self private_createLabel];
     _highLabel.font = [UIFont boldSystemFontOfSize:10*scale];
    _lowLabel = [self private_createLabel];
     _lowLabel.font = [UIFont boldSystemFontOfSize:10*scale];
...
//    label.font = [UIFont boldSystemFontOfSize:10*scale];
