//
//  YKSubBriefViewController.swift
//  ICO
//
...
class YKSubBriefViewController: YKCoinBaseViewController {
    ...
    override func viewDidLoad() {
        ...
        tableView?.register(UITableViewCell.self, forCellReuseIdentifier: YKSubBriefCellId)
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: YKSubBriefCellId, for: indexPath)
