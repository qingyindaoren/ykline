...
class YKCoinViewController: YKBaseTableViewController {
    ...
    override func viewDidLoad() {
        ...
        // Do any additional setup after loading the view.
                tableView?.register(UITableViewCell.self, forCellReuseIdentifier: YKCoinId)
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: YKCoinId, for: indexPath)
